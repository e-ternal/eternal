 ...
 */
 module.exports.loadFeatures = async (client) => {
    ...
    .then(() => {console.log(`eternal has connected to the mongo database`)})
    .catch((err) => {console.log(`eternal has failed to connect to the mongo database`); console.error(err)})
